...
export const ModifyMyInformation = () => {
    ...
    useEffect(() => {
      ...
      const handleSubmit = async (e) => {
        ...
        try{
            const response = await axios.put(`${import.meta.env.VITE_API_URL}/api/users/updateUser/${email}`, {email:newEmail, name:newName}, { headers: { 'Content-Type': 'application/json' }});
